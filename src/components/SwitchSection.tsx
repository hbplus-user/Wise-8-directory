    ...
    >
      <div className="container" style={{ zIndex: 1, textAlign: 'center', width: '100%', padding: 0 }}>
        <div className="bento-grid" style={{ justifyContent: 'center' }}>
          <div style={{ gridColumn: '1 / -1', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '0 40px' }}>
            <div
            ...
            <div style={{ position: 'relative', minHeight: '350px', width: '100%', maxWidth: '100%' }}>
              <div 
                style={{ 
                  position: 'absolute', 
                  width: '100%', 
              ...
              >
                <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', marginBottom: '32px', lineHeight: 1.1, width: '100%', textAlign: 'center' }}>
              ...
              >
                <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', marginBottom: '32px', color: '#fff', lineHeight: 1.1, width: '100%', textAlign: 'center' }}>
